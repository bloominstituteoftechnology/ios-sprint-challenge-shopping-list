...
class ShoppingListCollectionViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        return shoppingListController.shoppingListItems.count
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ShoppingItemCell", for: indexPath) as? ShoppingItemCollectionViewCell  else {
            fatalError("collection view cell idenitifer is wrong or the cell")
        }
        
        let shoppingItem = shoppingListController.shoppingListItems[indexPath.item]
        
        cell.nameLabel.text = shoppingItem.name
        cell.image.image = shoppingItem.image
...
//extension ShoppingListCollectionViewController: SettingsDelegate {
//
//}
